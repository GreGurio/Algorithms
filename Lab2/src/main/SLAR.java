...
public class SLAR extends Matrix implements SLARinterface {
    ...
    static public void showArr(int[][] array, int[] freeArg) {
        for(int i = 0; i < array.length; i++) {
            for (int j = 0; j < array[0].length; j++)
                System.out.print(array[i][j] + " ");
            System.out.print(" | " + freeArg[i]);
            System.out.print('\n');
        }
        System.out.println('\n');
    }
    static public void showArr(float[][] array, float[] freeArg) {
        for(int i = 0; i < array.length; i++) {
            for (int j = 0; j < array[0].length; j++)
                System.out.print(array[i][j] + " ");
            System.out.print(" | " + freeArg[i]);
    ...
    static public void showArr(float[][] array) {
        for(int i = 0; i < array.length; i++) {
            for (int j = 0; j < array[0].length; j++)
                System.out.print(array[i][j] + " ");
            System.out.print('\n');
