...
class MatrixTest {
    ...
    void gettersSettersTest() {
        assertEquals(matrix1.getMatrix(), sqareArray);
        assertEquals(matrix1.getIdentifier(), -101);
        matrix1.setMatrix(array);
        assertEquals(matrix1.getMatrix(), array);
        matrix1.setIdentifier(10);
        assertEquals(matrix1.getIdentifier(), 10);
    }
    @Test
    @DisplayName("New test for getters and setters")
    void ConstructorTest() {
        assertDoesNotThrow(() -> {
            ...
            Matrix matrix3 = new Matrix(array, 10);
            Matrix matrix4 = new Matrix(sqareArray);
        });
